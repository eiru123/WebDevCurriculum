...
| %H | %h | %T | %t | %P | %p | %an | %ae | %ad | %at | %cn | %ce | %cd | %ct | %s |
| ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 커밋 해시 | 짧은 길이 커밋 해시 | 트리 해시 |짧은 길이 트리 해시 | 부모 해시 | 짧은 길이 부모 해시 | 저자 이름 | 저자 메일 | 저자 시각 | 저자 상대적 시각 | 커미터 이름 | 커미터 메일 | 커미터 시각 | 커미터 상대적 시각 | 요약 |
